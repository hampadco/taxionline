...
namespace Admin.Controllers
{
 ...
 //
    public IActionResult Travel () {
           ...
           var qlist=db.tbl_Travels.ToList();
         
           foreach (var item in qlist)
           {
            var qpay=db.Tbl_pays.Where(a =>a.idtravel==item.Id).SingleOrDefault();
             var qname = db.tbl_Users.Where(a => a.phone == item.UserPhone).SingleOrDefault();
              var qnamedriver=db.Tbl_driver.Where(a =>a.Id==item.DriverId).SingleOrDefault();
                if (qpay!=null)
          {
          ...
          if (qnamedriver != null)
               ...
               Vm_Travel B=new Vm_Travel()
           {
               ...
               UserPhone=item.UserPhone,
                ...
                TypeMoney=TypeMoney,
                NameFamily = qname.NameFamily,
                driver=qnamedriver.NameFamily
