...
namespace  Admin.Controllers {
    ...
    public class PayController : BaseController {
        ...
        public IActionResult Index (int id) 
        {
            ...
            return RedirectToAction ("Request","pay",new {area="Admin"});
        ...
        public async Task<IActionResult> Request () {
           ...
           sumshop=qpay.Pay;
            var result = await _payment.Request (new DtoRequest () {
                    ...
                    Amount =qpay.Pay,
                    MerchantId = "448aebea-4e8c-4677-9548-6a285b6458cb"
      ...
      public IActionResult end(int? id)
        {
            ...
            qtravel.TypePay = "اتمام سفر";
             ...
             db.SaveChanges();
             info();
             return RedirectToAction("Travel","mapclient",new{area="Admin"});
